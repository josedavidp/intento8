...
const Footer = () => {
    ...
    const footerLink = [
        ...
        { id: 5, text: 'Cámara de Comercio Loja' },
        { id: 6, text: 'Bomberos' },
        { id: 7, text: 'Ecu 911' },
        { id: 8, text: 'Municipio de Loja' },
    ]
    return (
        <Fade left>
        <footer className="text-white poppins bg-blue">
            <div className="max-w-screen-xl px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                ...
                <div className="flex-grow flex justify-end flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        <h2 className="poppins text-gray-900 text-base mb-3 font-semibold">Contactos</h2>
                        <nav className="list-none mb-10 flex flex-col space-y-2">
                            {/* list  */}
                            {
            ...
            <div className="bg-blue-700">
                <div className="max-w-screen-xl mx-auto py-4 px-5 flex flex-wrap flex-col justify-center sm:flex-row">
                    <p className="text-white text-sm text-center sm:text-left">© 2023 Developed by —
                        <a href="#" rel="noopener noreferrer" className="text-white ml-1" target="_blank">Club de los 27</a>
                    </p>
                </div>
            </div>
        </footer>
