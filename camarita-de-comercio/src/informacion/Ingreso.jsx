...
const Ingreso = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      Swal.fire(
        "Error en registro",
        "Credenciales Incorrectas o Vacias",
        "error"
      );
        ...
        <div className="container mx-auto">
          <div className="flex flex-col lg:flex-row w-10/12 lg:w-8/12 bg-blue rounded-xl mx-auto shadow-lg overflow-hidden">
              ...
              <form onSubmit={handleSubmit}>
                <div className="mt-5">
                  <input
                    type="text"
                    placeholder="Email"
                    className="border border-gray py-1 px-2 w-full"
                    value={email}
                ...
                <div className="mt-2 text-white cursor-pointer float-right">
                ...
                <div className="mt-5">
                  <Link to="/perfil">
                    <button
                      type="submit"
                      className="mt-2 w-full bg-yellow py-3 text-center text-blue font-semibold"
                ...
                <div className="mt-5">
                  <Link to="/registro">
                    <button
                      type="submit"
                      className="w-full bg-yellow py-3 text-center text-blue font-semibold"
                    >
                      No tengo una cuenta
                    </button>
                  </Link>
            ...
            <div
              ...
              style={{
                backgroundImage: `url(${ImgIngresar})`,
                minHeight: "300px",
              }}
            ></div>
          </div>
