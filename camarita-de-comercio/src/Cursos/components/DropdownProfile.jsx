...
function DropdownProfile({align,nameId}) {
    ...
    <div className="relative inline-flex">
      ...
      >
        ...
        <div className="flex items-center truncate">
          <span className="truncate ml-2 text-sm font-medium dark:text-white group-hover:text-slate-800 dark:group-hover:text-slate-200">{nameId}</span>
